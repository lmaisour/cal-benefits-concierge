...
ALTER TABLE public.programs
  ...
  ADD COLUMN IF NOT EXISTS consumer_tags TEXT[];
...
COMMENT ON COLUMN public.programs.consumer_tags IS
  'Explicit consumer tags seeded from verified facts. Null or empty means no tag row.';
...
SET
  ...
  consumer_tags = ARRAY['Low income', 'Transit', 'Los Angeles County']
...
SET
  ...
  consumer_tags = ARRAY['Single-family home', 'LADWP water', 'Homeowner or renter'],
